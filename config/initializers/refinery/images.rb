...
Refinery::Images.configure do |config|
  ...
  # Configure image sizes
   config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"450x450>", :thumbnail=>"100x100>"}
  ...
  # config.s3_backend = Refinery::Core.s3_backend
   config.s3_bucket_name = 'wieser6' #ENV['S3_BUCKET']
  ...
  # config.dragonfly_secret = "c602c5d4691086b48fef9158497648ec8fc198c696db1ecc"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/ceinterone17/rails_projects/wieser6/public/system/refinery/images"
