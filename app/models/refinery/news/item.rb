module Refinery
  module News
    class Item < Refinery::Core::BaseModel
      ...
      attr_accessible :title, :body, :content, :source, :publish_date, :expiration_date, :image_id, :news_hero_image_id
      class Translation
      ...
      belongs_to :news_hero_image, :class_name => '::Refinery::Image'
